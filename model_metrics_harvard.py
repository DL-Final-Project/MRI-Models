...
train_df, test_df = train_test_split(harvard_df, test_size=0.195, random_state=42, stratify=harvard_df['Class'])
...
disp.plot()
#plt.savefig(f'temp/harvard/VGG16/test_vgg16_cm_display.png')
...
disp.plot()
#plt.savefig(f'temp/harvard/VGG16/train_vgg16_cm_display.png')
